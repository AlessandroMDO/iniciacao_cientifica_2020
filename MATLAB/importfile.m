...
%
% Example:
%   data = importfile1('data.dat', 1, 16384);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/03/25 11:37:31
...
formatSpec = '%12f%12f%12f%21f%32f%f%[^\n\r]';
...
data = table(dataArray{1:end-1}, 'VariableNames', {'ix','iy','iz','u','v','w'});
